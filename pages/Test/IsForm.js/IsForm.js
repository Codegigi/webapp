...
import styles from './isform.module.css'
        ...
        <div className={styles.formDemo}>
            <Dialog visible={showMessage} onHide={() => setShowMessage(false)} position="top" footer={dialogFooter} showHeader={false} breakpoints={{ '960px': '80vw' }} style={{ width: '30vw' }}>
                <div className="p-d-flex p-ai-center p-dir-col p-pt-6 p-px-3">
                   ...
                   <center><h5>Registration Successful!</h5></center> 
                    <p style={{ lineHeight: 1.5, textIndent: '1rem' }}>
                        Your account is registered under name <b>{formData.name}</b> it will be valid next 30 days without activation. Please check <b>{formData.email}</b> for activation instructions.
                    </p>
                </div>
            </Dialog>
            ...
            <div className="p-d-flex p-jc-center">
                <div className={styles.card}>
                    ...
                    <form onSubmit={formik.handleSubmit} className="p-fluid">
                        ...
                        <Button className={styles.btn_class} type="submit" label="Submit"  />
                    </form>
                </div>
            </div>
        </div>
